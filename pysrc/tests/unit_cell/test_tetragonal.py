...
"""
Unit tests for `xtallography.unit_cell.tetragonal` module
"""
# --- Imports
...
from xtallography.unit_cell import TetragonalUnitCell, CubicUnitCell


# --- Test Suites


class test_xtallography_unit_cell_tetragonal(unittest.TestCase):
    """
    ...
    def test_init():
        ...
        * `a`, `c` properties
        ...
        # centering = base
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.BASE)
        ...
        # centering = body
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.BODY)
        ...
        # centering = face
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.FACE)
    ...
    def test_to_julia(self):
        ...
        assert self.jl.isa(unit_cell_jl, self.jl.TetragonalUnitCell)
    ...
    def test_from_julia(self):
        ...
        unit_cell_jl = self.jl.TetragonalUnitCell(a, c)

        unit_cell = TetragonalUnitCell.from_julia(unit_cell_jl)
        assert unit_cell == TetragonalUnitCell(a, c)

        # ------ non-default centering

        # centering = primitive
        unit_cell_jl = self.jl.TetragonalUnitCell(
        ...
        # centering = base
        unit_cell_jl = self.jl.TetragonalUnitCell(
            a, c, centering=self.jl.base_centering
        )
        unit_cell = TetragonalUnitCell.from_julia(unit_cell_jl)
        assert unit_cell == TetragonalUnitCell(a, c, centering=Centering.BASE)

        # centering = body
        unit_cell_jl = self.jl.TetragonalUnitCell(
            a, c, centering=self.jl.body_centering
        )
        unit_cell = TetragonalUnitCell.from_julia(unit_cell_jl)
        assert unit_cell == TetragonalUnitCell(a, c, centering=Centering.BODY)

        # centering = face
        unit_cell_jl = self.jl.TetragonalUnitCell(
            a, c, centering=self.jl.face_centering
        )
        unit_cell = TetragonalUnitCell.from_julia(unit_cell_jl)
        assert unit_cell == TetragonalUnitCell(a, c, centering=Centering.FACE)
        ...
        unit_cell = TetragonalUnitCell.from_julia(unit_cell_jl)
        assert unit_cell == TetragonalUnitCell(
            a, c, symmetry_elements=symmetry_elements
        )
    ...
    def test_from_julia_invalid_arguments(self):
        ...
        # unit_cell_jl is not a TetragonalUnitCell
    ...
    def test_repr():
        ...
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.BASE)
        assert str(unit_cell) == (
            f"TetragonalUnitCell(a={a},c={c},centering=base,symmetry_elements=[])"
        )

        # centering = body
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.BODY)
        assert str(unit_cell) == (
            f"TetragonalUnitCell(a={a},c={c},centering=body,symmetry_elements=[])"
        )

        # centering = face
        unit_cell = TetragonalUnitCell(a, c, centering=Centering.FACE)
        assert str(unit_cell) == (
            f"TetragonalUnitCell(a={a},c={c},centering=face,symmetry_elements=[])"
        )
    ...
    def test_eq():
        ...
        # `a` values differ
        unit_cell_1 = TetragonalUnitCell(a, c)
        unit_cell_2 = TetragonalUnitCell(a + 1, c)
        assert unit_cell_1 != unit_cell_2

        # `c` values differ
        unit_cell_1 = TetragonalUnitCell(a, c)
        unit_cell_2 = TetragonalUnitCell(a, c + 3)
        assert unit_cell_1 != unit_cell_2

        # ------ symmetry differs

        # centerings differ
        unit_cell_1 = TetragonalUnitCell(a, c, centering=Centering.FACE)
        unit_cell_2 = TetragonalUnitCell(a, c, centering=Centering.BODY)
        assert unit_cell_1 != unit_cell_2
    ...
    def test_isclose():
        ...
        unit_cell_1 = TetragonalUnitCell(a, c)
        unit_cell_2 = TetragonalUnitCell(a + 0.1, c)
        ...
        unit_cell_1 = TetragonalUnitCell(a, c)
        unit_cell_2 = TetragonalUnitCell(a, c - 0.05)
        assert unit_cell_1.isclose(unit_cell_2, atol=0.2)
