...
@testset "RotationAxis constructor" begin
    # --- Valid arguments
    ...
    symmetry_element = RotationAxis(direction, location, n)
    ...
    @test_throws MethodError RotationAxis(direction, location, n)
    ...
    @test_throws InexactError(:Int64, Int64, 4.2) RotationAxis(direction, location, n)
end
...
@testset ":(==)(::RotationAxis,::RotationAxis)" begin
    ...
    symmetry_element_2 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
    ...
    symmetry_element_1 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
    symmetry_element_2 = RotationAxis((1//2, 0, 0), (0, 0, 0), 2)
    ...
    symmetry_element_1 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
    symmetry_element_2 = RotationAxis((1, 0, 0), (3//4, 0, 0), 2)

    @test symmetry_element_1 == symmetry_element_2

    # --- Equivalent rotation axes: directions differ, locations differ

    symmetry_element_1 = RotationAxis((2//3, 0, 0), (0, 0, 0), 2)
    symmetry_element_2 = RotationAxis((1, 0, 0), (3//2, 0, 0), 2)

    @test symmetry_element_1 == symmetry_element_2

    # --- Inequivalent rotation axes: directions differ

    symmetry_element_1 = RotationAxis((1, 1, 0), (0, 0, 0), 2)
    symmetry_element_2 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
    ...
    symmetry_element_1 = RotationAxis((1//3, 0, 0), (0, 1, 0), 2)
    symmetry_element_2 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
    ...
    symmetry_element_1 = RotationAxis((2, 0, 0), (2, 0, 0), 3)
    symmetry_element_2 = RotationAxis((1, 0, 0), (0, 0, 0), 2)
